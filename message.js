...
window.onload = function() {
    ...
    function usingDataMessage(xhttp) {
        ...
        for (let i = 0; i < myObj.length; i++) {
            ...
            document.getElementById("titreDiscussion").innerHTML += `<div class="ml-5 mb-2">
                                    <div class="flex gap-2">
                                        <svg class="w-10" data-jdenticon-value="`+elementJSON.username+`"></svg>
                                        <div class="flex flex-col">
                                            <span class="text-pink-800 text-xl font-semibold">`+elementJSON.username+`</span>
                                            <span class="text-gray-400 text-sm">`+elementJSON.dateMessage+`</span>
                                        </div>
                                    </div>
                                    <div class="pl-2">
